...
/**
 * The links an application or a release note carries, as a closed vocabulary.
 *
 ...
 * application, they are always read with it, and they are replaced wholesale on every write.
 */
 ...
 */
const parseLinks = (raw: string | null): ApplicationLink[] => {
  if (!raw) {
    return []
  }
...
export type { ApplicationLink, LinkInput, LinkKind }
