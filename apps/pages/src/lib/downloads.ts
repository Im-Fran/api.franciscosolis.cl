 ...
 * R2 URL handed to the browser — cannot express any of what this feature is: whether the application
...
type DownloadTicket = {
  ...
  f: string
  /** Application the file belongs to, so the serving route can check the pair without a join. */
  a: string
