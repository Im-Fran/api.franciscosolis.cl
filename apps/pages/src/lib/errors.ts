 ...
 * untouched. The editorial routes can trip three of them — an application's slug, an update's
 * version within its application, a wiki page's slug within its application — so the caller passes
