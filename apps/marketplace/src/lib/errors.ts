 ...
 * untouched. The editorial routes can trip three of them — a product's slug, a release's
 * version within its product, a wiki page's slug within its product — so the caller passes
