...
const productTranslations = translationsFor({
...
const releaseTranslations = translationsFor({
  title: prose(TRANSLATABLE_FIELD_LIMITS.title),
  body: proseBody(BODY_LIMITS.release),
})
...
const TRANSLATABLE = {
  ...
  release: RELEASE_TRANSLATABLE_FIELDS,
