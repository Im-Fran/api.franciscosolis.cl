...
type CreateManualSaleInput = {
  ...
  productSlug: string
  productName: string
  /** `purchase` grants the licence; `donation` records support for an optional-pay product. */
 ...
 *
 * Three figures rather than one, because "how much did this product make" has three honest
